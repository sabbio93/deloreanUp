...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeamonBackupApi.MountBindOptions();
  });
  ...
  describe('MountBindOptions', function() {
    it('should create an instance of MountBindOptions', function() {
      ...
      //var instance = new DeamonBackupApi.MountBindOptions();
      //expect(instance).to.be.a(DeamonBackupApi.MountBindOptions);
    });
