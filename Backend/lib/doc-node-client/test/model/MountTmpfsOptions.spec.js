...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeamonBackupApi.MountTmpfsOptions();
  });
  ...
  describe('MountTmpfsOptions', function() {
    it('should create an instance of MountTmpfsOptions', function() {
      ...
      //var instance = new DeamonBackupApi.MountTmpfsOptions();
      //expect(instance).to.be.a(DeamonBackupApi.MountTmpfsOptions);
    });
